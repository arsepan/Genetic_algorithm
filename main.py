...
def create_top_population(population, grade_tasks, employee_grade, hashmap_address, employee_address, distance):
    ...
    for idx, genom in enumerate(population):
        hashmap_score[idx] = fitness_genome(genom, grade_tasks, employee_grade, hashmap_address, employee_address,
                                            distance)
    ...
    for i in range(len(hashmap_score) // 2):
        top_population.append(
            append_time(population[hashmap_score_keys[i]], hashmap_address, employee_address, distance)[0])  #######
    return top_population, hashmap_score


def evolution(n: int, data_task, grade_tasks, employee_grade, hashmap_address, employee_address, distance,
              best_score=10000000):
    population = generate_population(data_task)
    top_population, _ = create_top_population(population, grade_tasks, employee_grade, hashmap_address,
                                              employee_address, distance)
    for i in range(n):
        ...
        top_population, hashmap_score = create_top_population(top_population, grade_tasks, employee_grade,
                                                              hashmap_address, employee_address, distance)
